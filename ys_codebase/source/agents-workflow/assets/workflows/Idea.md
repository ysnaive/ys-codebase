...
4. **立項流轉機制 (Promoted to Dev Plan)**：
   - 當靈感成熟並獲指示正式開立 Dev Plan 時，**直接將 Idea 檔案搬移至新開立的 Dev Plan 目錄並轉換為 [`__${module://agents-workflow/assets/templates/P00_discuss.md}__`](`__#{module://agents-workflow/assets/templates/P00_discuss.md}__`)**，達成完美無縫銜接。
...
- 當開發者宣告「將此 Idea 正式立項開發」時：
  ...
  2. 將提案文件搬移至該目錄，並轉換重命名為 [`__${module://agents-workflow/assets/templates/P00_discuss.md}__`](`__#{module://agents-workflow/assets/templates/P00_discuss.md}__`)。
