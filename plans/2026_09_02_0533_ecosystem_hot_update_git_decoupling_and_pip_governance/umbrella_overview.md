...
| :---: | :--- | :---: | :---: | :--- |
| **sub_01** | `sub_01_ecosystem_safe_hot_update_and_jit_synchronization` | Full Track | `Pending` | 全生態系安全熱更新與 JIT 變更感知自愈機制（依據 [R01](file:///workspace/ys-codebase/plans/2026_09_02_0533_ecosystem_hot_update_git_decoupling_and_pip_governance/R01_ecosystem_safe_hot_update_and_jit_synchronization.md)，涵蓋 core contributes JIT 自愈、agents-workflow JIT 投影同步、12 小時來源版本探測提示、dev dogfooding 閉環加固） |
...
- [ ] **里程碑 1 (sub_01)**：完成全生態系安全熱更新與 JIT 變更感知自愈機制，全模組消除過期快取與手動 reload 負擔。
