...
| :---: | :--- | :---: | :---: | :--- |
| **sub_01** | `sub_01_space_management_and_schema` | Full Track | `Pending` | **空間管理與資料架構**：模組骨架、UnifiedSymbol Schema、SpaceManager 多空間定義、2x2 組態矩陣、SHA1+mtime 增量指紋比對與 VFS 空間存儲。 |
...
- [ ] **里程碑 1 (Phase 0 / R01)**：完成 R01 專題架構調研、四大維度拆分與子計畫矩陣規劃。
