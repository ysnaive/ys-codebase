...
- **全階段文件模板剛性對齊與精確尋址**：所有 Phase (P00~P07 / fast_track_plan / umbrella_overview) 產出文件 **必須 100% 嚴格鏡像標準模板結構**（包含所有指定欄位、表格與 Header 規範標頭），嚴禁 Agent 自行簡化或遺漏模板區塊。各階段標準模板實體路徑指針如下：
  - Phase 0: [`P00_semantic_requirements.md`](.agents/templates/P00_semantic_requirements.md)
  - Phase 1: [`P01_requirements_spec.md`](.agents/templates/P01_requirements_spec.md)
  - Phase 2: [`P02_architecture_plan.md`](.agents/templates/P02_architecture_plan.md)
  - Phase 3: [`P03_api_spec.md`](.agents/templates/P03_api_spec.md)
  - Phase 4: [`P04_implementation_plan.md`](.agents/templates/P04_implementation_plan.md)
  - Phase 5: [`P05_task.md`](.agents/templates/P05_task.md)
  - Phase 6: [`P06_test_plan.md`](.agents/templates/P06_test_plan.md)
  - Phase 7: [`P07_walkthrough.md`](.agents/templates/P07_walkthrough.md)
  - Level 0 (Fast Track): [`fast_track_plan.md`](.agents/templates/fast_track_plan.md)
  - Level 2 (Umbrella): [`umbrella_overview.md`](.agents/templates/umbrella_overview.md)
  - 計畫日誌: [`changelog.md`](.agents/templates/changelog.md)
  - 現場交接: [`handoff.md`](.agents/templates/handoff.md)
